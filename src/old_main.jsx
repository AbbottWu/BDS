...
class Introduction_card extends React.Component {
  constructor(props) {
    super(props);
  ...
  make_content = function (t = 0) {
    return [this.props.images[t], this.props.intros[t]];
  }
    ...
    return (
      <ParallaxLayer
        ...
        <div className='container flex flex-col p-5 bg-white rounded-xl shadow-lg shadow-blue-400 w-11/12 md:(w-3/5)'>
          <h1 className='self-center text-3xl p-3 bg-blue-200 rounded-md text-sky-700'>{this.props.title}</h1>
          <hr className='mt-5' />
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Introduction_card images={images} intros={intros} title='卫星定位原理' />
      </div>
    )
  }
}
